...
const Form = () => {
    ...
    const acceptedFileItems = acceptedFiles.map((file, index) => (
        <li className="form__panel-browser-item" key={file.path || index} onClick={() => handleImageSelect(file)} style={{ cursor: 'pointer' }}>
    ...
    return (
        <div className="master">
            ...
            <div className="form__panel">
                ...
                <div {...getRootProps({ className: 'form__panel-dropzone' })}>
                    <input {...getInputProps()} />
                    <p>Drag and drop some files here, or click to select files</p>
                    <em>Available formats: jpg, png, bpm..</em>
                </div>

                <div className="form__panel-browser">
                    <h1>Image Browser</h1>
                    <ul>{acceptedFileItems}</ul>
                </div>

                <div className="form__panel-reset_btn"></div>
            ...
            {loading ? (
                ...
                <div className="canvas__editor">
                    ...
                    <div className="canvas__editor-controls__header">

                    </div>

                    <div className="canvas__editor-preset__controls">
                            <select
                    ...
                    <div className="canvas__editor-slider__container">
                        {filter.map((x, index) => (
